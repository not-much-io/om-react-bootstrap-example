...
document.write('<script>if (typeof goog != "undefined") { goog.require("om_next_mini_app.core"); } else { console.warn("ClojureScript could not load :main, did you forget to specify :asset-path?"); };</script>');